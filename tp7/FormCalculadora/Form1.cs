            ...
            if (textBox1.Text.Trim() != "")
            {
                ...
                switch (operador)
                {
                    case "+":
                        ...
                        textBox1.Text = Convert.ToString(NuevaCalculadora.Suma());
                        operando1 = 0;
                        operando2 = 0;
                    ...
                    case "-":
                        ...
                        NuevaCalculadora.OP1 = operando1;
                        NuevaCalculadora.OP2 = operando2;
                        textBox1.Text = Convert.ToString(NuevaCalculadora.Resta());
                        operando1 = 0;
                        operando2 = 0;
                        NuevaCalculadora = new Calculadora();
                        break;
                    case "*":
                        ...
                        NuevaCalculadora.OP1 = operando1;
                        NuevaCalculadora.OP2 = operando2;
                        textBox1.Text = Convert.ToString(NuevaCalculadora.Multiplicacion());
                        operando1 = 0;
                        operando2 = 0;
                        NuevaCalculadora = new Calculadora();
                        break;
                    case "/":
                        ...
                        NuevaCalculadora.OP1 = operando1;
                        NuevaCalculadora.OP2 = operando2;
                        textBox1.Text = Convert.ToString(NuevaCalculadora.Division());
                        operando1 = 0;
                        operando2 = 0;
                        NuevaCalculadora = new Calculadora();
                        break;
